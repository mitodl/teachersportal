...
class OAuth2AuthenticationTests(TestCase):
    ...
    """
    def test_returns_proper_user(self):
        """
    ...
    def test_none_case(self):
        """
        Super result doesn't give info, we return nothing.
        """
        request = RequestFactory().get(reverse('course-list'))
        subject = OAuth2Authentication()
        assert subject.authenticate(request) is None
